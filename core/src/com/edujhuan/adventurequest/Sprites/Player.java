...
public class Player extends Sprite {
	...
	private TextureRegion playerDead; // Must declare frame type (TextureRegion)
    ...
    public Player(World world, PlayScreen screen){
		...
		atackSheet = new Texture(Gdx.files.internal("atackr.png"));
		...
		playerDead= new TextureRegion(getTexture(), 1330, 65, 58, 58); // create the TextureRegion for player standing
