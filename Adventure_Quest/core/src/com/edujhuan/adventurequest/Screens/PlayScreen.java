...
import com.edujhuan.adventurequest.Tools.WorldContactListener;
...
public class PlayScreen implements Screen{ // we send the game it self to the screen
    ...
    public PlayScreen(AdventureQuest game){
        ...
        player = new Player(world, this); // o this passa PlayScreen para Player

        world.setContactListener(new WorldContactListener()); //vou implementar isso depois
